...
- [GitHub Action run](https://github.com/faster-cpython/benchmarking/actions/runs/14117014573)
...
- Geometric mean: 1.493x faster (HPT: reliability of 100.00%, 1.35x faster at 99th %ile)
- Memory usage: 1.28x
...
- Geometric mean: 1.151x faster (HPT: reliability of 100.00%, 1.08x faster at 99th %ile)
- Memory usage: 1.11x
